                    ...
                    <td>
                      <div class="row m-0">
                        <div class="col-3 m-0 px-1">
                          <a href="{{route ('frames.edit',compact('frame'))}}" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0"><i class="fas fa-edit text-gray"></i></a>
                        </div>
                        <div class="col-3 m-0 px-1">
                          @if($frame->status =='0')
                          <a href="{{route ('frames.status', $frame)}}" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0 text-white" id="statusX "><i class="fas fa-eye-slash text-dark"></i></a>
                          @else
                          <a href="{{route ('frames.status', $frame)}}" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0" id="statusX "><i class="fas fa-eye text-success"></i></a>
                          @endif
                        </div>
                        <div class="col-3 m-0 px-1">
                          <div class="d-inline">
                            ...
                            <button type="button" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0 text-danger" data-bs-toggle="modal" data-bs-target="#cornice{{$frame->id}}">
                              <strong> X</strong>
                            </button>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="row m-0">
                        <div class="col-3 m-0 px-1">
                          <a href="{{route ('cardboards.edit',compact('cardboard'))}}" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0"><i class="fas fa-edit text-gray"></i></a>
                        </div>
                        <div class="col-3 m-0 px-1">
                          @if($cardboard->status =='0')
                          <a href="{{route ('cardboards.status', $cardboard)}}" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0 text-white" id="statusX "><i class="fas fa-eye-slash text-dark"></i></a>
                          @else
                          <a href="{{route ('cardboards.status', $cardboard)}}" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0" id="statusX "><i class="fas fa-eye text-success"></i></a>
                          @endif
                        </div>
                        <div class="col-3 m-0 px-1">
                          <div class="d-inline">
                            ...
                            <button type="button" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0 text-danger" data-bs-toggle="modal" data-bs-target="#passepartout{{$cardboard->id}}">
                              <strong> X</strong>
                            </button>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="row m-0">
                        <div class="col-3 m-0 px-1">
                          <a href="{{route ('cardboardForRentals.edit',compact('cardboardForRental'))}}" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0"><i class="fas fa-edit text-gray"></i></a>
                        </div>
                        {{-- <div class="col-3 m-0 px-1">
                          @if($cardboardForRental->status =='0')
                          <a href="{{route ('cardboardForRentals.status', $cardboardForRental)}}" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0 text-white" id="statusX "><i class="fas fa-eye-slash text-dark"></i></a>
                          @else
                          <a href="{{route ('cardboardForRentals.status', $cardboardForRental)}}" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0" id="statusX "><i class="fas fa-eye text-success"></i></a>
                          @endif
                        </div> --}}
                        <div class="col-3 m-0 px-1">
                          <div class="d-inline">
                            ...
                            {{-- <button type="button" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0 text-danger" data-bs-toggle="modal" data-bs-target="#passepartout{{$cardboardForRental->id}}">
                              <strong> X</strong>
                            </button> --}}
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="row m-0">
                        <div class="col-3 m-0 px-1">
                          <a href="{{route ('photos.edit',compact('photo'))}}" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0"><i class="fas fa-edit text-gray"></i></a>
                        </div>
                        {{-- <div class="col-3 m-0 px-1">
                          @if($photo->status =='0')
                          <a href="{{route ('photos.status', $photo)}}" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0 text-white" id="statusX "><i class="fas fa-eye-slash text-dark"></i></a>
                          @else
                          <a href="{{route ('photos.status', $photo)}}" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0" id="statusX "><i class="fas fa-eye text-success"></i></a>
                          @endif
                        </div>
                        <div class="col-3 m-0 px-1">
                          <div class="d-inline">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="row m-0">
                        <div class="col-3 m-0 px-1">
                          <a href="{{route ('rentalModels.edit',compact('rentalModel'))}}" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0"><i class="fas fa-edit text-gray"></i></a>
                        </div>
                        <div class="col-3 m-0 px-1">
                          @if($rentalModel->status =='0')
                          <a href="{{route ('rentals.status', $rentalModel)}}" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0 text-white" id="statusX "><i class="fas fa-eye-slash text-dark"></i></a>
                          @else
                          <a href="{{route ('rentalModels.status', $rentalModel)}}" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0" id="statusX "><i class="fas fa-eye text-success"></i></a>
                          @endif
                        </div>
                        <div class="col-3 m-0 px-1">
                          <div class="d-inline">
                            ...
                            <button type="button" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0 text-danger" data-bs-toggle="modal" data-bs-target="#modello_{{$rentalModel->id}}">
                              <strong> X</strong>
                            </button>
                            
                            <!-- Modal -->
                            
                            <div class="modal fade" id="modello_{{$rentalModel->id}}" tabindex="-1" aria-labelledby="{{$rentalModel->id}}Label" aria-hidden="true">
                              <div class="modal-dialog">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="row m-0">
                        <div class="col-3 m-0 px-1">
                          <a href="{{route ('rentals.edit',compact('rental'))}}" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0"><i class="fas fa-edit text-gray"></i></a>
                        </div>
                        <div class="col-3 m-0 px-1">
                          @if($rental->status =='0')
                          <a href="{{route ('rentals.status', $rental)}}" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0 text-white" id="statusX "><i class="fas fa-eye-slash text-dark"></i></a>
                          @else
                          <a href="{{route ('rentals.status', $rental)}}" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0" id="statusX "><i class="fas fa-eye text-success"></i></a>
                          @endif
                        </div>
                        <div class="col-3 m-0 px-1">
                          <div class="d-inline">
                            ...
                            <button type="button" class="btn btn-small shadow-gray shadow-h-none rounded-0 p-1 m-0 text-danger" data-bs-toggle="modal" data-bs-target="#modello_{{$rental->id}}">
                              <strong> X</strong>
                            </button>
                            
                            <!-- Modal -->
                            
                            <div class="modal fade" id="modello_{{$rental->id}}" tabindex="-1" aria-labelledby="{{$rental->id}}Label" aria-hidden="true">
                              <div class="modal-dialog">
                                
                                <div class="modal-content">
                                  <div class="modal-header ">
                                    <h3 class="text-center w-100" id="{{$rental->id}}Label"><strong>{{$rental->rentalModel_id}}</strong></h3>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                  </div>
                                  <div class="modal-body">
                                    <p>vuoi eliminare questo passepartout?</p>
