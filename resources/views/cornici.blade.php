    ...
    <div class="conteiner-fluid container-max p-0 mx-auto">
        <div class="row justify-content-center px-0 pt-5 m-0">
            <div class="col-12 text-center">
                <h2>IN LEGNO</h2>
                <p>
                    Questi sono alcuni dei nostri profili artigianali, usati per realizzare cornici in vari colori, 
        ...
        <div class="row justify-content-center px-0 pt-5 m-0">       
            ...
            @if($frame->status == '1' && $frame->essenze !='Ferro')
