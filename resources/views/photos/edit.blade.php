...
<div class="conteiner-fluid container-max p-0 mx-auto">
    <div class="row justify-content-center px-0 pt-5 m-0">
        <div class="col-12 text-center">
            <h1>Modifica la Foto di una cornice </h1>
        </div>
    </div>
</div>
      ...
      <form action="{{route('photos.update', $photo)}}" method="post" enctype="multipart/form-data">
        ...
        <section class="row pt-2 justify-content-center">
         <div class="col-12 col-md-2 mb-3">
            ...
            <select class="form-select rounded-0"  name="frame_id"  id="frame_id" aria-label="Default select example">
              <option value="{{$photo->frame_id}}" selected >{{$photo->frame_id}}</option>
          ...
          <div class="col-12 col-md-2 mb-3">
            ...
            <select class="form-select rounded-0"  name="color_id"  id="color_id" aria-label="Default select example" >
              <option value="{{$photo->color_id}}" selected> {{$photo->color_id}}</option>
          ...
          <div class="col-12 col-md-3">
            ...
            <input class="form-control rounded-0" name="img" type="file" id="img" >
            @error('img')
            <div class="alert alert-danger info-error">{{ $message }}</div>
            @enderror
          </div>
