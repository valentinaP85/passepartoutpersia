...
use App\Http\Controllers\BookingRentalDetailController;
...
Route::middleware([RevisorMiddleware::class])->group(function(){
    ...
    Route::get('/richieste/richiesteP', [RentalController::class, 'richiesteP'])->name('richieste.richiesteP');
    Route::get('/richieste/{bookingRental}/noleggiShow', [RentalController::class, 'noleggiShow'])->name('richieste.noleggiShow');
    Route::get('/richieste/acquisti', [QuoteController::class, 'richiesteAcquisti'])->name('richieste.acquisti');
    Route::get('/richieste/{quote}/acquistoShow', [QuoteController::class, 'acquistoShow'])->name('richieste.acquistoShow');
    ...
    Route::post('/rentals/{rental}/increment', [RentalController::class, 'increment'])->name('rental.increment');
    //Route::get('/rentals/{rental}/edit', [RentalController::class, 'edit'])->name('rentals.edit');
...
Route::post('/BookingRentalDetails/store', [BookingRentalDetailController::class, 'store'])->name('bookingRentalDetails.store');
Route::delete('/BookingRentalDetails/{BookingRentalDetail}/delete', [BookingRentalDetailController::class, 'destroy'])->name('BookingRentalDetails.destroy');
...
Route::get('/preventivo-acquisto', [HomeController::class, 'preventivoAcquisto'])->name('preventivo-acquisto');

Route::post('/preventivo-acquisto', [QuoteController::class, 'richiestaPreventivo'])->name('richiestaPreventivo');